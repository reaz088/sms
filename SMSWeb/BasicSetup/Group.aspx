<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="Group.aspx.cs" Inherits="BasicSetup_Group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="dashboard-con" data-ng-controller="groupCtrl as vm" class="container-fluid">
            <div class="row">
                        ...
                        <div  class="x-box x-box">
                          ...
                          <div class="x-box-body">
                              ...
                              <md-input-container class="md-block">
                                ...
                                <input type="text" data-ng-model="vm.objGroup.group_name"/>
                             </md-input-container>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x-box">
                                ...
                                <tbody>
                                  <tr data-ng-repeat="g in vm.groups">
                                    <td>{{g.group_id}}</td>
                                    <td>{{g.group_name}}</td>
                                    <td>
                                      <a class="btn btn-xs btn-warning" href="#" data-ng-click="vm.view(g)" role="button">edit</a>
                                      <a class="btn btn-xs btn-primary" href="#" data-ng-click="vm.view(g)" role="button">view</a>
