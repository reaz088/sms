<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="SessionYear.aspx.cs" Inherits="BasicSetup_SessionYear" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="dashboard-con" data-ng-controller="sessionYearCtrl as vm" class="container-fluid">
            <div class="row">
                    ...
                    <div data-ng-if="vm.entry_form==true">
                        ...
                        <div  class="x-box x-box">
                          ...
                          <div class="x-box-body">
                                ...
                                <h4>Start On</h4>
                                <md-datepicker data-ng-model="vm.objSessionYear.start_on" md-placeholder="Enter date"></md-datepicker>
                                <h4>End On</h4>
                                <md-datepicker data-ng-model="vm.objSessionYear.ends_on" md-placeholder="Enter date"></md-datepicker>
                            
                           
                              <md-input-container class="md-block">
                                <label>SessionYear Name</label>
                                <textarea type="text" data-ng-model="vm.objSessionYear.description"></textarea>
                             </md-input-container>
                           
                              <input type="checkbox" data-ng-model="vm.objSessionYear.status" ng-true-value="1" ng-false-value="2"> Status{{vm.objSessionYear.status}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x-box">
                                ...
                                <tbody>
                                  <tr data-ng-repeat="d in vm.sessionYears">
                                    <td data-ng-init="d.start_on=vm.formatDate(d.start_on)">{{d.start_on| date:"dd-MMM-yyyy"}}</td>
                                    <td data-ng-init="d.ends_on=vm.formatDate(d.ends_on)">{{d.ends_on | date:"dd-MMM-yyyy"}}</td>
                                    <td>{{d.description}}</td>
                                    <td>{{d.status}}</td>
            ...
            <script src="sessionYear.js"></script>
          </div>
</asp:Content>
