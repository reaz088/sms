<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="District.aspx.cs" Inherits="BasicSetup_District" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="dashboard-con" data-ng-controller="districtCtrl as vm" class="container-fluid">
            <div class="row">
                        ...
                        <div  class="x-box x-box">
                          ...
                          <div class="x-box-body">
                              ...
                              <md-input-container class="md-block">
                                ...
                                <input type="text" data-ng-model="vm.objDistrict.district_name"/>
                             </md-input-container>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x-box">
                                ...
                                <tbody>
                                  <tr data-ng-repeat="d in vm.districts">
                                    <td>{{d.district_id}}</td>
